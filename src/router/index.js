    ...
    children: [
      {
        ...
        children: [
          ...
          // 我的班级
          {
            path: "myClass",
            component: () =>
              import("../views/officeCenter/office-center-child/my-class.vue"),
          },
          // 班级评测
          {
            path: "evaluation",
          ...
          // 我的学生
          {
            path: "student",
            component: () =>
              import("../views/officeCenter/office-center-child/student.vue"),
          },
          // 学生详情页面
          {
            path: "studentDetail",
    ...
    children: [
      {
        ...
        children: [
          ...
          // 反馈
          {
            ...
            name: "feedback",
            component: () =>
              import("../views/personalCenter/router-child/feedback/index.vue"),
          },
          // 历史反馈
          {
          ...
          // 我的钱包
          {
            ...
            name: "wallet",
            component: () =>
              import("../views/personalCenter/router-child/money/index.vue"),
          },
          // 充值金额
          {
            path: "recharge",
